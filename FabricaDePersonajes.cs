...
namespace EspacioPersonaje
{
    public class FabricaDePersonajes
    {
        ...
        private Dictionary<Elemento, List<Elemento>> debilidadesPorTipo = new Dictionary<Elemento, List<Elemento>>
        {
            { Elemento.Fuego, new List<Elemento> { Elemento.Agua, Elemento.Tierra, Elemento.Roca } },
            { Elemento.Agua, new List<Elemento> { Elemento.Planta, Elemento.Electrico } },
            { Elemento.Planta, new List<Elemento> { Elemento.Fuego, Elemento.Hielo, Elemento.Veneno, Elemento.Volador, Elemento.Bicho } },
            { Elemento.Electrico, new List<Elemento> { Elemento.Tierra } },
            { Elemento.Normal, new List<Elemento> { Elemento.Lucha } },
            { Elemento.Hielo, new List<Elemento> { Elemento.Fuego, Elemento.Lucha, Elemento.Roca, Elemento.Acero } },
            { Elemento.Lucha, new List<Elemento> { Elemento.Volador, Elemento.Psiquico, Elemento.Hada } },
            { Elemento.Veneno, new List<Elemento> { Elemento.Tierra, Elemento.Psiquico } },
            { Elemento.Tierra, new List<Elemento> { Elemento.Agua, Elemento.Planta, Elemento.Hielo } },
            { Elemento.Volador, new List<Elemento> { Elemento.Electrico, Elemento.Hielo, Elemento.Roca } },
            { Elemento.Psiquico, new List<Elemento> { Elemento.Bicho, Elemento.Fantasma, Elemento.Siniestro } },
            { Elemento.Bicho, new List<Elemento> { Elemento.Fuego, Elemento.Volador, Elemento.Roca } },
            { Elemento.Roca, new List<Elemento> { Elemento.Agua, Elemento.Planta, Elemento.Lucha, Elemento.Tierra, Elemento.Acero } },
            { Elemento.Fantasma, new List<Elemento> { Elemento.Fantasma, Elemento.Siniestro } },
            { Elemento.Dragon, new List<Elemento> { Elemento.Hielo, Elemento.Dragon, Elemento.Hada } },
            { Elemento.Siniestro, new List<Elemento> { Elemento.Lucha, Elemento.Bicho, Elemento.Hada } },
            { Elemento.Acero, new List<Elemento> { Elemento.Fuego, Elemento.Lucha, Elemento.Tierra } },
            { Elemento.Hada, new List<Elemento> { Elemento.Veneno, Elemento.Acero } }
        };
        ...
        public async Task<Personaje> CrearPersonajeAsync()
        {
            ...
            foreach (var (nombreMovimiento, tipoMovimiento) in movimientos)
            {
                ...
                {
                    int poder = random.Next(1, 11);

                    if (movimientosDelTipo.Count < 3)
                    {
                        movimientosDelTipo.Add(new Movimiento(nombreMovimiento, tipoMovimiento, poder));
                    }
                }
            }
            ...
            Caracteristicas caracteristicas = new Caracteristicas(ataque, defensa, velocidad, nivel);
            Datos datos = new Datos(datosPokemon.tipo, datosPokemon.nombre, debilidades, movimientosPokemon);
